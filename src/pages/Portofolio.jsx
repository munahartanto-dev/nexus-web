...
export default function PortofolioPage() {
  ...
  return (
    <div className="w-full">
      {/* SECTION 1 - PAGE HERO */}
      <section className="relative min-h-[40vh] flex items-center justify-center pt-[72px] pb-[72px] md:pt-[100px] md:pb-[100px] bg-[#FAF9F5] overflow-hidden border-b border-[#F4F4F4]">
        {/* Background blob */}
