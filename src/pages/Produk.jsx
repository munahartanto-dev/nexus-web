...
export default function LayananPage() {
  ...
  return (
    <div className="w-full bg-[#FAF9F5]">
      {/* SECTION 1 - PAGE HERO */}
      <section className="relative min-h-[40vh] flex items-center justify-center pt-[72px] pb-[72px] md:pt-[100px] md:pb-[100px] bg-[#FAF9F5] overflow-hidden">
        {/* Background blob */}
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10 text-center flex flex-col items-center space-y-6 reveal opacity-0 translate-y-5">
